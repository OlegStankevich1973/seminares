...
int ColculateTask(int[] inputArray, int downBorder, int upBorder)
{
    ...
    while (i < inputArray.Length)
    {
        ...
        {
            // строка42 чтобы показать эти элементы
               Console.WriteLine("Элемент,который соответствуют условию "+"("+inputArray[i]+") ");
            //    строка 44 суммирует элементы которые соответсвуют условию
            resultCount++;
